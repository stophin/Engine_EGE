...
INT EP_TruncateImage(EPTYPE x, EPTYPE y, EPTYPE w, EPTYPE h, EIMAGE image, EPTYPE tx, EPTYPE ty, EPTYPE tw, EPTYPE th, EIMAGE image_bk = NULL, INT bk = 0, ECOLOR c = BLACK, PEPoint cp = NULL, PointF * ds = 0, PointF * geom = 0);
